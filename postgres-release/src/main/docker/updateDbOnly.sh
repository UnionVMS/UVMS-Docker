...
psql -U asset -d $1 --host=$2 --single-transaction -q -f  eu.europa.ec.fisheries${unionvms.project.asset.module}.sql >/dev/null
echo "Running  audit.sql to create tables and init data"
psql -U audit -d $1 --host=$2 --single-transaction -q -f  eu.europa.ec.fisheries${unionvms.project.audit.module}.sql >/dev/null
echo "Running config.sql to create tables and init data"
psql -U config -d $1 --host=$2 --single-transaction -q -f  eu.europa.ec.fisheries${unionvms.project.config.module}.sql >/dev/null
echo "Running exchange.sql to create tables and init data"
psql -U exchange -d $1 --host=$2 --single-transaction -q -f  eu.europa.ec.fisheries${unionvms.project.exchange.module}.sql >/dev/null
echo "Running mobterm.sql to create tables and init data"
psql -U mobterm -d $1 --host=$2 --single-transaction -q -f  eu.europa.ec.fisheries${unionvms.project.mobileterminal.module}.sql >/dev/null
...
psql -U usm -d $1 --host=$2 --single-transaction -q -f eu.europa.ec.fisheries${unionvms.project.user.liquibase.version}.sql >/dev/null
echo "Running spatial.sql to create tables and init data"
psql -U spatial -d $1 --host=$2 --single-transaction -q -f eu.europa.ec.fisheries${unionvms.project.spatial.module}.sql >/dev/null
echo "Running mdr.sql to create tables and init data"
psql -U mdr -d $1 --host=$2 --single-transaction -q -f eu.europa.ec.fisheries${unionvms.project.mdr.module}.sql >/dev/null
echo "Running activity.sql to create tables and init data"
psql -U activity -d $1 --host=$2 --single-transaction -q -f eu.europa.ec.fisheries${unionvms.project.activity.module}.sql >/dev/null
echo "Running reporting.sql to create tables and init data"
psql -U reporting -d $1 --host=$2 --single-transaction -q -f eu.europa.ec.fisheries${unionvms.project.reporting.module}.sql >/dev/null
echo "Running subscription.sql to create tables and init data"
psql -U subscription -d $1 --host=$2 --single-transaction -q -f eu.europa.ec.fisheries${unionvms.project.subscription.module}.sql >/dev/null
