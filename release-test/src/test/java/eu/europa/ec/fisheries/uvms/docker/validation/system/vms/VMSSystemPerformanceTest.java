...
public class VMSSystemPerformanceTest extends AbstractRestServiceTest {
    ...
    public void createPositionAndTriggerRulePerformanceTest() throws Exception {
        ...
        CustomRuleType customRule = CustomRuleHelper.sendAllFSToFLUXEndpoint(testAsset.getCountryCode(), fluxEndpoint);
        ...
        for (LatLong position : postitions) {
            ...
            FLUXHelper.sendPositionToFluxPlugin(testAsset, position);
            ...
            assertThat(setReportRequest.getReport().getMovement().getAssetName(), is(testAsset.getName()));
            assertThat(setReportRequest.getReport().getMovement().getIrcs(), is(testAsset.getIrcs()));
