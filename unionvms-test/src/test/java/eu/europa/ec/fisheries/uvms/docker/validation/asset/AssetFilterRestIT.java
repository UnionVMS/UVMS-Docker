...
public class AssetFilterRestIT extends AbstractRest{
    ...
    public void createAssetFilterFromJsonTest() { 
        ...
        AssetFilterResponseDto assetFilterResponseDto = jsonb.fromJson(assetFilterCreateResp, AssetFilterResponseDto.class);
	...
	public void updateAssetFilterTest() {
		...
		String assetFilterToUpdate = "{\"name\":\"båtar2\",\"id\":\""+filterId+"\",\"filter\": [{\"values\":[{\"value\":42, \"operator\":\"operator update test\"}],\"type\": \"dsad\", \"inverse\": false,\"isNumber\": true}] }";
	...
	public void getAssetFilterListTest() {
		...
		AssetFilterResponseDto assetFilterResponseDto1 = jsonb.fromJson(assetFilterCreateResp1, AssetFilterResponseDto.class);
		String id1 = assetFilterResponseDto1.getId();
		AssetFilterResponseDto assetFilterResponseDto2 = jsonb.fromJson(assetFilterCreateResp2, AssetFilterResponseDto.class);
		String id2 = assetFilterResponseDto2.getId();
		AssetFilterResponseDto assetFilterResponseDto3 = jsonb.fromJson(assetFilterCreateResp3, AssetFilterResponseDto.class);
