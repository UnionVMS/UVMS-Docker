...
public class MovementJmsIT extends AbstractRest {
	...
	public void createMovementBatchRequestTest() throws Exception {
		...
		mobileTerminal = MobileTerminalTestHelper.assignMobileTerminal(testAsset, mobileTerminal);
		...
		final CreateMovementBatchRequest createMovementBatchRequest = movementHelper
				.createMovementBatchRequest(testAsset, mobileTerminal, latLongList);
	...
	public void createMovementRequestTest() throws Exception {
		...
		assertNull(createMovementResponse.getMovement().getCalculatedCourse());
		assertNull(createMovementResponse.getMovement().getCalculatedSpeed());
