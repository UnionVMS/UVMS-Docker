...
addJbossAll config-module-3.0.12 /opt/jboss/jboss-deployment/config/jboss-all.xml
...
addJbossAll movement-module-3.0.15 /opt/jboss/jboss-deployment/movement/jboss-all.xml
addJbossAll asset-module-3.0.14 /opt/jboss/jboss-deployment/asset/jboss-all.xml
addJbossAll audit-module-3.0.13 /opt/jboss/jboss-deployment/audit/jboss-all.xml
addJbossAll exchange-module-3.0.13 /opt/jboss/jboss-deployment/exchange/jboss-all.xml
addJbossAll mobileterminal-module-3.0.15 /opt/jboss/jboss-deployment/mobile/jboss-all.xml
...
addJbossAlltoWar unionvms-web-3.0.6 /opt/jboss/jboss-deployment/web-app/jboss-deployment-structure.xml
