...
addJbossAll config-module-3.0.9 /opt/jboss/jboss-deployment/config/jboss-all.xml
...
addJbossAll audit-module-3.0.9 /opt/jboss/jboss-deployment/audit/jboss-all.xml
addJbossAll exchange-dbaccess-module-3.0.5 /opt/jboss/jboss-deployment/general/jboss-all.xml
addJbossAll exchange-module-3.0.10 /opt/jboss/jboss-deployment/exchange/jboss-all.xml
