...
addJbossAll reporting-module-1.0.4 /opt/jboss/jboss-deployment/reporting/jboss-all.xml
...
addJbossAll audit-module-3.0.8 /opt/jboss/jboss-deployment/audit/jboss-all.xml
