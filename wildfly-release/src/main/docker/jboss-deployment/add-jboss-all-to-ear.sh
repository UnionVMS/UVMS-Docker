...
addJbossAll movement-module-3.0.10 /opt/jboss/jboss-deployment/movement/jboss-all.xml
addJbossAll asset-module-3.0.10 /opt/jboss/jboss-deployment/asset/jboss-all.xml
...
addJbossAll exchange-module-3.0.7 /opt/jboss/jboss-deployment/exchange/jboss-all.xml
addJbossAll mobileterminal-module-3.0.10 /opt/jboss/jboss-deployment/mobile/jboss-all.xml
