...
addJbossAll mobileterminal-dbaccess-module-3.0.4 /opt/jboss/jboss-deployment/general/jboss-all.xml
addJbossAll mobileterminal-module-3.0.5 /opt/jboss/jboss-deployment/mobile/jboss-all.xml
