...
addJbossAll movement-module-3.0.8 /opt/jboss/jboss-deployment/movement/jboss-all.xml
addJbossAll asset-module-3.0.5 /opt/jboss/jboss-deployment/asset/jboss-all.xml
addJbossAll asset-dbaccess-module-3.0.4 /opt/jboss/jboss-deployment/general/jboss-all.xml
...
addJbossAlltoWar unionvms-web-3.0.5-SNAPSHOT /opt/jboss/jboss-deployment/web-app/jboss-deployment-structure.xml
