...
docker run -it -p 9990:9990 -p 8787:8787 -p 8080:8080 --name wildfly --net-alias wildfly --net=uvms -m 6G -d -v c:/uvms/app/logs:/app/logs -v c:/uvms/wildfly:/opt/jboss/wildfly/standalone/log uvms/wildfly-release
